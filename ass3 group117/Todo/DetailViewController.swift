...
class DetailViewController: UIViewController {
  ...
  @IBOutlet weak var iosLabel: UITextField!
    @IBOutlet var ios: UITextField!
    @IBOutlet var database: UITextField!
    @IBOutlet var eeis: UITextField!
    @IBOutlet var itps: UITextField!
    var todo: ToDoItem?
  ...
  @IBAction func tapDone(_ sender: AnyObject) {
    ...
    if let todo = todo {
      ...
      todo = ToDoItem(id: uuid, image: image, title: todoTitleLabel.text!, date: todoDatePicker.date, course: "ios")
      todos.append(todo!)
    }
